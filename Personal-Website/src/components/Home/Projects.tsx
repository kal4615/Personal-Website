    ...
    return(
        <section id="projects" className="py-20 bg-white px-6">
            ...
            <div className="p-6 bg-gray-100 rounded-2xl shadow hover:shadow-lg">
                <h3 className="text-2xl font-semibold">Contrax</h3>
            ...
            <div className="p-6 bg-gray-100 rounded-2xl shadow hover:shadow-lg">
                <h3 className="text-2xl font-semibold">NutriApp</h3>
                <p className="text-lg mt-2 text-gray-600">
            ...
            <div className="p-6 bg-gray-100 rounded-2xl shadow hover:shadow-lg">
                <h3 className="text-2xl font-semibold">Blogger</h3>
                <p className="text-lg mt-2 text-gray-600">
            ...
            <div className="p-6 bg-gray-100 rounded-2xl shadow hover:shadow-lg">
                <h3 className="text-2xl font-semibold">Recipe Domain</h3>
                <p className="text-lg mt-2 text-gray-600">
